...
public class Log {
    ...
    public void error(String nombre, String mensaje, Exception e) {
        ...
        try {
            ...
            fh = new FileHandler(rutaLocal + "logs" + separador + formato() + "_brasystem_error.txt", true);
    ...
    public void suceso(String nombre, String suceso) {
        ...
        try {
            ...
            fh = new FileHandler(rutaLocal + "logs" + separador + formato() + "_brasystem_suceso.txt", true);
            logger.addHandler(fh);
            logger.setLevel(Level.ALL);
            SimpleFormatter formatter = new SimpleFormatter();
            fh.setFormatter(formatter);
